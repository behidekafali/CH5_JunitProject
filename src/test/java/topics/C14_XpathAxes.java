...
public class C14_XpathAxes {
    /*
    xpath eksenleri normal xpath yöntemiyle bulunması mümkün olmayan dinamik ögeleri bulmak için kullanılır
    xpath eksenleri: dinamik ögeleri bulmak için kullanılır
    xpath eksenleri:genellikle İD NAME CLASS OLMADIĞI durumlarda tercih edilebilir
     */
