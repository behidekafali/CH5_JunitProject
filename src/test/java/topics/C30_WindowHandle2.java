...
//    Create a new window
        ...
        String window3 = driver.getWindowHandle();//Window3 windowHandle değerini alıyoruz.(Sayfanın kimliği)

//    Open https://www.linkedin.com/ in the second tab
        driver.switchTo().window("window2").get("https://www.linkedin.com");//driver ı window2'ye (second tab) switch ettik.

//    Open https://clarusway.com/ in the last window
        driver.switchTo().window("window3").get("https://clarusway.com");//driver ı window3'e (last window) switch ettik.


//    Open https://www.youtube.com/ in the first tab
        driver.switchTo().window("window1").get("https://www.google.com");//driver ı window1'e (first tab) switch ettik.'
