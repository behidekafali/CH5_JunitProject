...
//        Create new tab
        driver.switchTo().newWindow(WindowType.TAB); //newWindow() methodu ile açılan yeni sayfaya driver otomatik olarak geçer.

//        Go to https://www.linkedin.com/ in the open tab
        driver.get("https://www.linkedin.com");

//        Create new window
        driver.switchTo().newWindow(WindowType.WINDOW); //newWindow() methodu ile açılan yeni sayfaya driver otomatik olarak geçer.
...
//        driver.close() kullanırsak driver ın son bulduğu sayfa kapanır .
