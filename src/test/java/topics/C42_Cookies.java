...
public class C42_Cookies extends TestBase {
   ...
   /*
    addCookie(): Belirtilen çerezleri tarayıcıya ekler.
    deleteCookieNamed(): Belirli bir isme sahip çerezi siler.
    deleteCookie(): Belirtilen çerezi siler.
    deleteAllCookies(): Tüm çerezleri siler.
    getCookieNamed(): Belirli bir isme sahip çerezi döner.isim ile çağırabilir.
    getCookies(): Tarayıcıda mevcut olan tüm çerezleri döner.listeleyebilir.
*/
    /*
